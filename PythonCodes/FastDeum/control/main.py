...
def auto_run():
    try:
        print("start sound_")
        os.system('omxplayer --vol 3000 /home/pi/Desktop/sound/start.wav')
    ...
    while True:
        ...
        if lets_stop:
            try:
                ...
                print("normal_stop")
                os.system('omxplayer --vol 3000 /home/pi/Desktop/sound/normal_stop.wav')
        ...
        if lets_stop == 3:
            try:
                cv2.destroyAllWindows()
                print("fire")
                os.system('omxplayer --vol 3000 /home/pi/Desktop/sound/fire.wav')
        ...
        if lets_stop == 4:
            try:
                cv2.destroyAllWindows()
                print("food_is_out")
                os.system('omxplayer --vol 3000 /home/pi/Desktop/sound/food_is_out.wav')
        ...
        if lets_stop == 5:
            try:
                ...
                os.system('omxplayer --vol 3000 /home/pi/Desktop/sound/no_food_detected.wav')
